                    ...
                    <section>
                        ...
                        <form method="post" action="{{ route('employees.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <x-text-input id="firstName" name="first_name" type="text" class="mt-1 block w-full" autocomplete="name" :value="old('first_name')"/>
                            ...
                            <div>
                                ...
                                <x-text-input id="lastName" name="last_name" type="text" class="mt-1 block w-full" autocomplete="name" :value="old('last_name')"/>
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" autocomplete="phone" :value="old('phone')"/>
